    ...
    public:
        ...
        void add_head(int data)
        {
            ...
            if(this->head == nullptr)
            {
                this->head = new_node;
                this->tail = new_node;
                this->head->next = new_node;  // only one node
            } else
            {                 
        ...
        void remove_tail()
        {
            if(this->tail == nullptr)
                ...
                while(current != this->tail){ // this still works as it finds correct node
                    previous = current;
                    current = current->next;
                }
        ...
        void print_list()
        {
            if(this->head == nullptr){
                ...
                // The do while loop fits perfectrly in this case;
                do
                {
                    cout << current->data << " ";
                    current = current->next;
...
{
    CircularSinglyLinkedList list(12);
    list.add_head(23);
    list.add_head(15);
    list.add_tail(20);
    list.add_at(2, 13);
